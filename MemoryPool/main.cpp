...
public:
	...
	// 2. 小对象分配测试
	static void testSmallAllocation(bool bTestSysMalloc)
	{
	...
	// 3. 多线程测试
	static void testMultiThreaded(bool bTestSysMalloc)
	{
	...
	// 4. 混合大小测试
	static void testMixedSizes(bool bTestSysMalloc)
	{
